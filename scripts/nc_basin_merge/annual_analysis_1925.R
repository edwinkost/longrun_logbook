...
#~ tws_file = nc_open("/projects/0/dfguu/users/edwin/05min_runs_november_2015_merged/pcrglobwb_modflow_from_1925/1925_to_2010/TWS.nc")
...
plot(year, correct_TWS)
lines(year, correct_TWS)
