...
cmd = ''; print cmd
cmd = 'cdo add %s/snowCoverSWE_snowFreeWater_annuaAvg.nc %s/snowFreeWater_annuaAvg.nc %s/snowCoverSWE_snowFreeWater_annuaAvg.nc' %(complete_output_folder, complete_output_folder, complete_output_folder)
print cmd
os.system(cmd)
#~ cmd = ''; print cmd
