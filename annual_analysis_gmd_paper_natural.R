...
pre_file = nc_open( paste(merged_pcrglobwb_output_folder, "/precipitation_annuaTot_output_1958_to_2015.nc"               , sep = "") )
eva_file = nc_open( paste(merged_pcrglobwb_output_folder, "/totalEvaporation_annuaTot_output_1958_to_2015.nc"            , sep = "") )
run_file = nc_open( paste(merged_pcrglobwb_output_folder, "/totalRunoff_annuaTot_output_1958_to_2015.nc"                 , sep = "") )  # TODO: Also estimate it from the discharge
rch_file = nc_open( paste(merged_pcrglobwb_output_folder, "/gwRecharge_annuaTot_output_1958_to_2015.nc"                  , sep = "") )  # TODO: Also estimate baseflow.
snw_file = nc_open( paste(merged_pcrglobwb_output_folder, "/snowCoverSWE_annuaAvg_output_1958_to_2015.nc"                , sep = "") )
snf_file = nc_open( paste(merged_pcrglobwb_output_folder, "/snowFreeWater_annuaAvg_output_1958_to_2015.nc"               , sep = "") )
swt_file = nc_open( paste(merged_pcrglobwb_output_folder, "/surfaceWaterStorage_annuaAvg_output_1958_to_2015.nc"         , sep = "") )
top_file = nc_open( paste(merged_pcrglobwb_output_folder, "/topWaterLayer_annuaAvg_output_1958_to_2015.nc"               , sep = "") )
int_file = nc_open( paste(merged_pcrglobwb_output_folder, "/interceptStor_annuaAvg_output_1958_to_2015.nc"               , sep = "") )
upp_file = nc_open( paste(merged_pcrglobwb_output_folder, "/storUppTotal_annuaAvg_output_1958_to_2015.nc"                , sep = "") )
low_file = nc_open( paste(merged_pcrglobwb_output_folder, "/storLowTotal_annuaAvg_output_1958_to_2015.nc"                , sep = "") )

gwa_file = nc_open( paste(merged_pcrglobwb_output_folder, "/storGroundwater_annuaAvg_output_1958_to_2015.nc"             , sep = "") )
gwf_file = nc_open( paste(merged_pcrglobwb_output_folder, "/storGroundwaterFossil_annuaAvg_output_1958_to_2015.nc"       , sep = "") )

tws_file = nc_open( paste(merged_pcrglobwb_output_folder, "/totalWaterStorageThickness_annuaAvg_output_1958_to_2015.nc"  , sep = "") )
