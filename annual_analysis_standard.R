...
gwt_active_file = nc_open( paste(merged_pcrglobwb_output_folder, "/storGroundwater_annuaAvg_output_1958_to_2015.nc"      , sep = "") )
gwt_fossil_file = nc_open( paste(merged_pcrglobwb_output_folder, "/storGroundwaterFossil_annuaAvg_output_1958_to_2015.nc", sep = "") )
